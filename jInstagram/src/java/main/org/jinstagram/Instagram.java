...
public class Instagram {
     ...
     * @throws InstagramException if any error occurs
     */
    public MediaFeed getRecentMediaFeed(long userId, Integer count) throws InstagramException {
        Preconditions.checkNotNull(userId, "UserId cannot be null.");

        String methodName = String.format(Methods.USERS_RECENT_MEDIA, userId);
        Map<String, String> params = new HashMap<String, String>();
        params.put(QueryParam.COUNT,""+count);
        MediaFeed recentMediaFeed = this.createInstagramObject(Verbs.GET, MediaFeed.class, methodName, params);
     ...
     * @throws InstagramException if any error occurs
     */
    public MediaFeed getRecentMediaSinceId(long userId, String sinceMediaId) throws InstagramException {
        Preconditions.checkNotNull(userId, "UserId cannot be null.");

        String methodName = String.format(Methods.USERS_RECENT_MEDIA, userId);
        Map<String, String> params = new HashMap<String, String>();
        params.put(QueryParam.MIN_ID,sinceMediaId);
        params.put(QueryParam.COUNT,"1000");
        MediaFeed recentMediaFeed = this.createInstagramObject(Verbs.GET, MediaFeed.class, methodName, params);
     ...
     *
     * @param locationId a id of the Location.
     * @return a MediaFeed object.
     * @throws InstagramException if any error occurs.
     */
